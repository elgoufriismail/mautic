...
<head>
    <meta charset="UTF-8" />
    <title>
        <?php /* echo $view['slots']->get('pageTitle', 'Mautic'); */ ?>Bridges
    </title>
                    ...
                    <div class="panel" name="form-login">
                        <div class="panel-body">
                            <div class="mautic-logo img-circle mb-md text-center">
                                <img src="<?php echo $view['assets']->getUrl('app/assets/images/mautic_logo_lb200.png'); ?>" alt="" style="width: inherit; height: inherit;">
