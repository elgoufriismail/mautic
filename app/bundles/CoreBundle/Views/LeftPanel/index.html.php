...
<div class="sidebar-header">
    <!-- brand -->
    <a class="mautic-brand<?php echo (!empty($extraMenu)) ? ' pull-left pl-0 pr-0' : ''; ?>" href="#" style="text-align:center;">
        <img src="<?php echo $view['assets']->getUrl('app/assets/images/Bridges_logo.png'); ?>" alt="" style="width: 85px;margin-top: 1px;">
        <!-- logo figure -->
